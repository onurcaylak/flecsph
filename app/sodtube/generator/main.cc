...
int main(int argc, char * argv[]){
  ...
  if(equal_separation){
    ...
    tparticles += generate_lattice(lattice_type,2,rbox_min,rbox_max,sph_separation,tparticles-1,count);
    parts_lr = tparticles-parts_mid;
    tparticles += generate_lattice(lattice_type,2,lbox_min,lbox_max,sph_separation,tparticles-1,count);
    count = false;
  }
  double lr_sph_sep = 0.;
  double temp_part = 0;
  ...
  if(equal_mass){
    ...
    tparticles += generate_lattice(lattice_type,2,rbox_min,rbox_max,lr_sph_sep,tparticles-1,count);
    tparticles += generate_lattice(lattice_type,2,lbox_min,lbox_max,lr_sph_sep,tparticles-1,count);
    count = false;
  }
  ...
  if(equal_separation){
    ...
    tparticles += generate_lattice(lattice_type,2,rbox_min,rbox_max,sph_separation,tparticles-1,count,x,y,z);
    tparticles += generate_lattice(lattice_type,2,lbox_min,lbox_max,sph_separation,tparticles-1,count,x,y,z);
  }
  if(equal_mass){
    tparticles = generate_lattice(lattice_type,2,cbox_min,cbox_max,sph_separation,0,count,x,y,z);
    tparticles += generate_lattice(lattice_type,2,rbox_min,rbox_max,lr_sph_sep,tparticles-1,count,x,y,z);
    tparticles += generate_lattice(lattice_type,2,lbox_min,lbox_max,lr_sph_sep,tparticles-1,count,x,y,z);
  }
